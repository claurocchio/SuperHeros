...
//				con.disconnect();
				try{
					con = getConnection(URL_MARVEL_CHARACTERS + URL_PARAM_LIMIT + URL_VALUE_LIMIT + URL_PARAM_OFFSET + offset);
				} catch (Exception e) {
					e.printStackTrace();
...
//		con.setRequestProperty("User-Agent", USER_AGENT);
	 ...
	 */
	private ArrayList<Personaje> parsearPersonajes(StringBuffer stData)
			throws IOException, JsonProcessingException, UnsupportedEncodingException, JsonParseException,
